...
#ifndef BOOST_RANDOM_SPRNG_DETAIL_BUFFER_HPP
#define BOOST_RANDOM_SPRNG_DETAIL_BUFFER_HPP
...
namespace boost { namespace random { namespace sprng { namespace detail {
...
} } } } // namespace boost::random::sprng::detail

#endif // BOOST_RANDOM_SPRNG_DETAIL_BUFFER_HPP
