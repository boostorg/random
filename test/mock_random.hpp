...
#if defined(BOOST_RANDOM_TEST_RANDOM_MOCK)

#if defined(BOOST_RANDOM_PROVIDER_WINCRYPT) || defined(BOOST_RANDOM_PROVIDER_POSIX)
#define BOOST_RANDOM_TEST_RANDOM_MOCK_LINKAGE BOOST_SYMBOL_IMPORT
#else
#define BOOST_RANDOM_TEST_RANDOM_MOCK_LINKAGE
#endif

//! \returns  true  if the provider can be mocked - if not then the test
//!                 should skip negative testing
BOOST_RANDOM_TEST_RANDOM_MOCK_LINKAGE bool expectations_capable();
...
BOOST_RANDOM_TEST_RANDOM_MOCK_LINKAGE bool expectations_met();
...
BOOST_RANDOM_TEST_RANDOM_MOCK_LINKAGE void expect_next_call_success(bool success);

//! \returns  true  if the provider acquires a context
BOOST_RANDOM_TEST_RANDOM_MOCK_LINKAGE bool provider_acquires_context();
...
#define BOOST_RANDOM_PROVIDER_POSIX_IMPL_OPEN mockopen
#define BOOST_RANDOM_PROVIDER_POSIX_IMPL_READ mockread
...
#endif // BOOST_RANDOM_TEST_RANDOM_MOCK
