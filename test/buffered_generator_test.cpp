...
void test(const std::string & name, const PRNG &)
{
  ...
  boost::basic_buffered_generator<PRNG,result_type> gen_default;
  boost::basic_buffered_generator<PRNG,result_type> gen_copy(rng);
  boost::basic_buffered_generator<PRNG&,result_type> gen_ref(rng);
